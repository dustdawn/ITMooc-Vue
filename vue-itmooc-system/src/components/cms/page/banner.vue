<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 用户列表区域 -->
      <el-table :data="bannerList" border highlight-current-row>
        <el-table-column type="index" prop="index"></el-table-column>
        <el-table-column label="轮播图名称" prop="name"></el-table-column>
        <el-table-column label="轮播图地址" prop="value"></el-table-column>
...
<script>
  import * as cmsApi from '../api/cms'
    export default {
      ...
      methods : {
        getModel() {
          cmsApi.get_model('5e982b2155d6b309a9db48e4').then(res => {
            if (res) {
