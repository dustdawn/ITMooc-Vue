        ...
        <div class="">
          ...
          <div class="sign-in">
           ...
           <!-- <a href="#" class="personal"><span class="personalIco"></span>消息</a>
            ...
            <a href="http://ucenter.itmooc.com/" class="personal" target="_blank">我的学习</a>
            <a href="javascript:;" @click="showlogin" v-if="logined == false">登陆&nbsp;|&nbsp;注册</a>
            <a href="http://teacher.itmooc.com/" class="personal" target="_blank">教学提供方</a>
            <a href="http://system.itmooc.com/" class="personal" target="_blank">系统后台</a>
          </div>
          <div class="starch">
